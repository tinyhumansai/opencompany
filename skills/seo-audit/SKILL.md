...
4. **Content** — thin/duplicate pages, keyword gaps vs. competitors.
5. **Off-page** — referring domains and toxic links.
6. **Prioritize** every finding by impact × effort into Now / Next / Later.

## Output

A one-page summary plus a table: `finding · impact · effort · owner`. Park any
change that alters live pages for the operator's approval.
